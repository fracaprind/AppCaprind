...
export default function VerifyKey() {
    ...
    const verifyKey = async () => {
        ...
        await api.get('user/val-key-recover-pass-app/' + recoverPasswordApp)
            .then((response) => {
                ...
                if (err.response) {
                    ...
                    setLoading(false);
                    Alert.alert("", "Erro: Tente mais tarde3!");
                }
            });
    ...
    const editPassword = async () => {
        ...
        await api.put('user/update-password-app', {ID, password}, {headers})
        .then((response) => {
